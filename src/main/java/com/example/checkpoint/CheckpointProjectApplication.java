...
public class CheckpointProjectApplication {
    ...
    CommandLineRunner runner(CheckpointRepository repository, TaskRepository taskRepository) {
        return args -> {
            ...
            repository.save(new Checkpoint(1l, "Gather Requirements", taskList1));
            ...
            repository.save(new Checkpoint(2l, "Project Kickoff", taskList2));
            ...
            repository.save(new Checkpoint(3l, "Build", taskList3));
            ...
            repository.save(new Checkpoint(4l, "Integration test", taskList4));
            ...
            repository.save(new Checkpoint(5l, "User Acceptance Test", taskList5));
